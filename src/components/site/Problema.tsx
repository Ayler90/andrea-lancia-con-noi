    ...
    <section id="problema" className="py-20 md:py-32">
      <div className="container-narrow">
        <div className="max-w-3xl mx-auto">
          <p className="eyebrow mb-6">— Il problema</p>

          <h2 className="h-display text-4xl md:text-5xl lg:text-6xl">
            Hai un'offerta. Adesso <em>come si lancia?</em>
          </h2>

          <div className="mt-10 space-y-5 text-lg md:text-xl text-foreground/80 leading-relaxed">
            <p>
            ...
            <p className="font-semibold text-foreground">Solo che... come si fa un lancio?</p>
          </div>

          <ul className="mt-8 space-y-3">
            {domande.map((d) => (
              <li key={d} className="flex items-start gap-4 text-base md:text-lg text-foreground/75">
          ...
          <div className="mt-12 p-8 md:p-10 rounded-3xl bg-surface border border-border">
