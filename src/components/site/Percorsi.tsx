  ...
  consulenza: [
    {
      ...
      title: "Consulenza",
      italic: "Strategica",
      desc: "Una call da 60 minuti per definire la tua strategia di lancio. Analizziamo insieme il tuo problema e usciamo con un piano d'azione chiaro.",
      bullets: ["Audit del tuo funnel", "Piano d'azione concreto", "Registrazione della call", "Report scritto"],
      cta: "Prenota la consulenza",
      ctaHref: "/consulenza-strategica",
      external: false,
      image: p6,
      bg: "bg-[#C4D9DC]",
    },
