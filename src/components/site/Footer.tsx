  ...
  return (
    <footer id="contatti" data-cursor-light style={{ backgroundColor: "#1B2F52" }} className="text-white relative overflow-hidden">
      ...
      <div className="absolute pointer-events-none"
        style={{ width: 680, height: 680, borderRadius: "50%", background: "radial-gradient(circle, rgba(108,159,168,0.10) 0%, transparent 70%)", filter: "blur(60px)", animation: "footer-glow 8s ease-in-out infinite", top: "10%", left: "20%" }}
      />
