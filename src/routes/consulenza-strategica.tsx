...
const CAL_URL = "https://cal.com/andreabonomo-mktg/consulenza-strategica";
    ...
    <main className="min-h-screen bg-background">
      ...
      <section id="prenota" className="py-16 md:py-20 px-2 md:px-4 bg-foreground relative overflow-hidden" data-cursor-light>
        ...
        <div className="container-narrow max-w-4xl mx-auto relative z-10">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: "1.5px solid rgba(196,217,220,0.2)" }}>
            <iframe
              src={`${CAL_URL}?embed=true`}
              className="w-full"
              style={{ height: "680px", border: "none", backgroundColor: "white" }}
              title="Prenota consulenza strategica"
            />
          </div>
