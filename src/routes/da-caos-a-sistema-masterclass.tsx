...
function CountdownBanner() {
  ...
  return (
    <div className="bar-original w-full py-2.5 px-4 text-center font-semibold text-white whitespace-nowrap overflow-hidden" style={{ backgroundColor: "#4B6380", lineHeight: "1.4", fontSize: "0.875rem" }}>
        ...
        <div className="container-narrow relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
            <h2 className="h-display font-bold text-white leading-[1.1]" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
              Stai gestendo ogni tuo lancio e creando offerte{" "}
              <em style={{ color: "#C4D9DC" }}>senza un piano preciso?</em>
            </h2>
