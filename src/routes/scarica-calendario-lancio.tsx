      ...
      <div className="container-narrow max-w-4xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="pill bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 inline-flex"
          >
            Acquista ora a 2,99€ →
          </a>
        </div>
...
function ScaricaCalendarioLancio() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* ── FEATURES BAND ── */}
      <section data-cursor-light style={{ backgroundColor: "#156686" }} className="py-16 md:py-20">
      ...
      {/* ── PURCHASE ── */}
      <section id="form" className="py-16 md:py-20 bg-foreground relative overflow-hidden" data-cursor-light>
        {/* Glow orbs */}
          ...
          <div className="relative">
            ...
            <div className="bg-white rounded-xl overflow-hidden" data-cursor-dark>
              ...
              <div className="md:hidden pt-6 pb-10 text-center">
                ...
                <a href={PURCHASE_URL} target="_blank" rel="noreferrer" onClick={() => posthog.capture("calendario_cta_acquista", { position: "mobile" })} className="pill bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 block w-full text-center whitespace-nowrap">
                  Acquista ora a 2,99€ →
                </a>
              ...
              <div className="hidden md:block px-14 pt-12 pb-12">
                ...
                <div className="flex gap-0">
                  ...
                  <div className="w-72 flex-shrink-0 pl-12 flex flex-col justify-center items-center text-center">
                    ...
                    <a href={PURCHASE_URL} target="_blank" rel="noreferrer" onClick={() => posthog.capture("calendario_cta_acquista", { position: "desktop" })} className="pill bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 text-center block w-full">
                      Acquista ora a 2,99€ →
                    </a>
